...
void APP_Tasks ( void )
{
    ...
    short mags[3];         //magnetometer for the 3 axes
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)
                {
                    ...
                    x_coord = x_accel*(3/32000);
                    y_coord = y_accel*(3/32000);                            
                    
                    appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;
                    appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
                    appData.xCoordinate =(int8_t)x_coord;
                    appData.yCoordinate =(int8_t)y_coord;
                    vector ++;
                    movement_length = 0;
                }
            }
